...
const WhatsAppBadge = () => {
    ...
    return (
        <div className="fixed bottom-5 left-5 z-[5] flex items-center gap-3 sm:bottom-8 sm:left-8">
            {!dismissedHint && (
                <span className="hidden select-none rounded-full bg-card px-3 py-1.5 text-sm text-foreground shadow-lg animate-bounce sm:block">
            ...
            <a
                ...
                className="group relative flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-lg transition-transform hover:scale-110"
            >
